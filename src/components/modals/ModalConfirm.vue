...
/* Teo aloha: gap:10px (.cfm-box) + margin-top manokana isaky ny anak-
...
.cfm-title { color: #fff9e0; font-size: 16px; font-weight: 800; margin: 14px 0 0; }
.cfm-msg   { color: rgba(255,245,200,.45); font-size: 12.5px; line-height: 1.5; margin-top: 10px; }

.cfm-btns { display: flex; margin-top: 24px; width: 100%; }
.cfm-btns > * + * { margin-left: 10px; }
